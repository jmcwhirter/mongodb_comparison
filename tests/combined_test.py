...
azure_client = pymongo.MongoClient("mongodb://mcwhirter-cosmos-db-46961:K8Rb9r2Y09atRzxRR5n6lDyWyJG7fD34mE79aEhqALltEDdTao2PVouYlGN4R7zMni1dAKmhZSgButCAGH4mLw==@mcwhirter-cosmos-db-46961.documents.azure.com:10255/?ssl=true&replicaSet=globaldb")
...
print('Expected results:')
print("\t [{'_id': 1, 'a': {'b': 5}}, {'_id': 4, 'a': 'abc'}, {'_id': 2, 'a': 10}, {'_id': 3, 'a': [1, 2, 3]}]")
print('Results returned (Local):')
print('\t',local_results)
print('Results returned (Azure):')
print('\t',azure_results)
